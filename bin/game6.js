...
(lib.player_art_mc = function(mode,startPosition,loop) {
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#CCCCCC").s().dr(-30,-5,60,10);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.player_art_mc, new cjs.Rectangle(-30,-5,60,10), null);
...
(lib.hr_hit_mc = function(mode,startPosition,loop) {
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,255,255,0.008)").s().dr(-160,-15,320,30);
	this.shape.setTransform(160,15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.hr_hit_mc, new cjs.Rectangle(0,0,320,30), null);
...
(lib.hit_mc = function(mode,startPosition,loop) {
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FFFF").s().dr(-35,-10,70,20);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.hit_mc, new cjs.Rectangle(-35,-10,70,20), null);
...
(lib.game_complete_mc = function(mode,startPosition,loop) {
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF6600").s().p("");
	this.shape.setTransform(100,11.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFFFFF").ss(4,1,1).p("");
	this.shape_1.setTransform(100,11.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(100,11.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.game_complete_mc, new cjs.Rectangle(-2,-2,204,26.2), null);
...
(lib.game_back_mc = function(mode,startPosition,loop) {
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().dr(-160,-160,320,320);
	this.shape.setTransform(160,160);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.game_back_mc, new cjs.Rectangle(0,0,320,320), null);
...
(lib.error_mc = function(mode,startPosition,loop) {
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().dr(-150,-149.95,300,299.9);
	this.shape.setTransform(150,150.0012,1,1.0004);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.error_mc, new cjs.Rectangle(0,0,300,300), null);
...
(lib.ball_mc = function(mode,startPosition,loop) {
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#CCCCCC").s().dr(-5,-5,10,10);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.ball_mc, new cjs.Rectangle(-5,-5,10,10), null);
...
(lib.back_mc = function(mode,startPosition,loop) {
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#666666").s().dr(-160,-240,320,480);
	this.shape.setTransform(160,240);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// g
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().dr(-150,-149.95,300,299.9);
	this.shape.setTransform(150,150.0012,1,1.0004);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.area_mc, new cjs.Rectangle(0,0,300,300), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.player_art_mc.cache(-32,-7,64,14);

	this.timeline.addTween(cjs.Tween.get(this.player_art_mc).wait(1));

}).prototype = getMCSymbolPrototype(lib.player_mc, new cjs.Rectangle(-30,-5,60,10), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.hit_mc.cache(-37,-12,74,24);

	this.timeline.addTween(cjs.Tween.get(this.hit_mc).wait(1));

}).prototype = getMCSymbolPrototype(lib.L_R_btn, new cjs.Rectangle(-61.2,-29.5,122.5,59), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		_player.w = _player.nominalBounds.width;
		_player.h = _player.nominalBounds.height;
		//エリア
		var _area = this.area_mc;
		_area._x = _area.x + 5;
		_area._y = _area.y + 5;
		_area._w = _area.nominalBounds.width + 5;
		_area._h = _area.nominalBounds.height + 5;
		//ボール
		...
		this.stop_func = function() {
			//ブロック全体削除
			_this.removeChild( _this.getChildByName( "block_set_mc" ) );
			//毎秒処理削除
		...
		this.reset_func = function() {
			...
			for ( var ix = 0;  ix < 7; ix++ ) {
				for ( var iy = 0; iy < 6; iy++ ) {
					...
					block_mc.x = ix * 40;
					block_mc.y = iy * 20;
					block_mc.name = "x_" + ix + "_y_" + iy;
					block_set_mc.addChild( block_mc );
				};
			};
			//移動速度
			_ball.speed_x_num =  -1 * Number( _root.in_time_array[ _root.active_obj.level ] );
			_ball.speed_y_num  = -1 * Number( _root.in_time_array[ _root.active_obj.level ] );
			//跳ね返りのふり幅
			_ball.speed_bounce_num = Number( _root.in_time_array[ _root.active_obj.level ] );
			//開始
			_this.start_func();
			//毎秒処理追加
		...
		this.tick_func = function( event_obj ) {
			...
			//移動
			_ball.x += _ball.speed_x_num;
			_ball.y += _ball.speed_y_num;
			//左の壁に当たる
			if ( _ball.x <= _area._x ) {
				_ball.speed_x_num *= -1;
			//右の壁に当たる
			} else if ( _ball.x >= _area._w ) {
				_ball.speed_x_num *= -1;
			};
			//上の壁に当たる
			if ( _ball.y <= _area._y ) {
			...
			var _point1 = _ball.localToLocal( 0, 0, target_mc );
			//衝突判定
			if ( target_mc.hitTest( _point1.x, _point1.y ) ) {
				//当たった方向の確認用
				var check_bool = false;
				//横方向反転
				if ( target_mc.hitTest( ( _point1.x - _ball.speed_x_num ), _point1.y ) == false ) {
					_ball.speed_x_num *= -1;
					check_bool = true;
				};
				//縦方向反転
				if ( target_mc.hitTest( _point1.x, ( _point1.y - _ball.speed_y_num ) ) == false ) {
					_ball.speed_y_num *= -1;
					check_bool = true;
				};
				//例外的なレアケース
				...
				for ( var _mc of target_mc.children ) {
					//※ボールとブロックの相対距離
					var _point2 = _ball.localToLocal( 0, 0, _mc );
					if ( _mc.hitTest( _point2.x, _point2.y ) ) {
			...
			//プレイヤーに当たる
			//※ボールとプレイヤーの相対距離
			var _point3 = _ball.localToLocal( 0, 0, _player );
			//衝突判定
			if ( _player.hitTest( _point3.x, _point3.y ) ) {
				var hit_num = ( _ball.x - _player.x ) / ( _player.w / 2 );
				_ball.speed_x_num = hit_num * _ball.speed_bounce_num;
				_ball.speed_y_num = -1 * Math.abs( _ball.speed_y_num );
				//効果音
	...
	mask._off = true;
	mask.graphics.p("A4/4/MAx/AAAMAAAAx/Mgx/AAAg");
	...
	this.ball_mc.setTransform(160,280);
	...
	this.player_mc.setTransform(160,290);
	...
	this.hr_hit_mc.setTransform(0,320);
	...
	this.error_mc.setTransform(10,10);
	this.error_mc.cache(-2,-2,304,304);
	...
	this.area_mc.cache(-2,-2,304,304);
	...
	this.game_back_mc.cache(-2,-2,324,324);
